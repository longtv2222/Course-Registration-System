...
public class Database {
	...
	/**
	 * Loads all of the course registrations, connecting the courses/lectures and the students.
	 * @param courses The list of all the courses on the sql server
	...
	/**
	 * Debug code, Test connection to a local database and print what is setup in the SqlServer class.
	 * @param args
	 * @throws SQLException
	 */
